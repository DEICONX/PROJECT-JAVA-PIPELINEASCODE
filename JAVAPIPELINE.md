...
![](Screenshot%202025-11-03%20125214.png)
...
![](Screenshot%202025-11-03%20142323.png)

--------------------------------------

> Now iam connected to web browser of jenkins using `<public ip>:8080`

![](Screenshot%202025-11-03%20142332.png)
...
![](Screenshot%202025-11-03%20142401.png)
...
![](Screenshot%202025-11-03%20142459.png)

-----------------------------------------

> **Paste the public key here and save it**

![](Screenshot%202025-11-03%20142527.png)
...
![](Screenshot%202025-11-03%20142601.png)

------------------------------

> **Paste the public key here and save it**

![](Screenshot%202025-11-03%20142714.png)

-------------------------

> go to **[deploy/tomcat]** server terminal `ls -a` you will find a .ssh folder `cd .ssh`
>
> `ls` you find authorized_keys and `sudo nano authorized keys`

![](Screenshot%202025-11-03%20142746.png)

-----------------------------------

> **Paste the public key here and save it**

![](Screenshot%202025-11-03%20142813.png)
...
![](Screenshot%202025-11-03%20142948.png)
...
![](Screenshot%202025-11-03%20143356.png)
...
![](Screenshot%202025-11-03%20143538.png)

---------------------------------------

> Now select **Global Credentials**

![](Screenshot%202025-11-03%20143548.png)
...
![](Screenshot%202025-11-03%20143639.png)
...
![](Screenshot%202025-11-03%20143713.png)

----------------------------------

> We have created/added our credentials to Jenkins

![](Screenshot%202025-11-03%20143903.png)
...
![](Screenshot%202025-11-03%20144025.png)
...
![](Screenshot%202025-11-03%20144124.png)
...
![](Screenshot%202025-11-03%20144332.png)
...
![](Screenshot%202025-11-03%20144401.png)

-----------------------

> for maven use `readlink -f $(which mvn)` and copy upto before `/bin`

![](Screenshot%202025-11-03%20144622.png)
...
![](Screenshot%202025-11-03%20144645.png)
...
![](Screenshot%202025-11-03%20144749.png)
...
![](Screenshot%202025-11-03%20144804.png)
...
![](Screenshot%202025-11-03%20144859.png)
...
![](Screenshot%202025-11-03%20145017.png)

------------------

> Now we have created node for each server and connected it to jenkins

![](Screenshot%202025-11-03%20145428.png)
...
pipeline {
    ...
    environment {
        ...
        NEXUS_URL = '[http://18.232.136.245:8081](http://18.232.136.245:8081)'
        NEXUS_REPO = 'JAVA'
        NEXUS_GROUP = 'com/web/cal'
        NEXUS_ARTIFACT = 'webapp-add'
        TOMCAT_URL = '[http://18.207.93.131:8080/manager/text](http://18.207.93.131:8080/manager/text)'
    }
        ...
        stage('Checkout Code') {
            steps {
                ...
                checkout([$class: 'GitSCM',
                    branches: [[name: '*/main']],
                    userRemoteConfigs: [[
                        url: '[https://github.com/DEICONX/Java-Web-Calculator-JEN.git](https://github.com/DEICONX/Java-Web-Calculator-JEN.git)'
                    ]]
                ])
            }
        }
...
![](Screenshot%202025-11-05%20121855.png)
...
![](Screenshot%202025-11-05%20121523.png)

--------------------------

> Output of our sonarqube web page

![](Screenshot%202025-11-05%20122016.png)

----------------------

> Output of our nexus webpage

![](Screenshot%202025-11-05%20121957.png)

----------------------

> output of our Tomcat web page

![](Screenshot%202025-11-05%20124845.png)

---------------------

> Output of our application

![](Screenshot%202025-11-05%20124854.png)

---------------

> New commit in github and pipeline is auto builded

![](Screenshot%202025-11-05%20125349.png)

-------------------

> Output of our application

![](Screenshot%202025-11-05%20125416.png)
